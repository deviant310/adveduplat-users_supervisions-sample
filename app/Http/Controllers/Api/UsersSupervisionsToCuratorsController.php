...
class UsersSupervisionsToCuratorsController extends Controller
{
    use BaseRestTrait;
    ...
    public function index(QueryBuilderRequest $request, $id): Response
    {
         ...
         */
        $relatedCurators = $supervision
            ->curators()
            ->buildQueryFromRequest($request);

        return $this->response($relatedCurators->get(), $relatedCurators->count());
    }
